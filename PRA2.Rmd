...
### 2.1.10. Representem histogrames de les variables
...
### 2.1.12. Representem l'histograma de les variables *renewable_generation_mw*, *renewable_generation_perc* i *renewable_generation_perc_bin*
...
variables numèriques en base a les columnes *date* i *province*. En aquest 
...
### 2.2.10. Histogrames de la precipitació i la insolació
...
### 2.2.11. Histogrames de la velocitat del vent
...
### 2.2.12. Eliminem les columnes innecessàries fent servir una matriu de correlació
...
buits en el dataset. Per tant, procedirem a tractar-los. En primer lloc,
presentem un resum dels elements buits per a cada columna del dataset:
...
Presentem també les dimensions
