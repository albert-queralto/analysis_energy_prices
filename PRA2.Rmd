...
Ho treure doncs si et sembla bé. Miraré a veure si ho puc fer d'una altra manera 
però si no ho fem sense pip install, no passa res. Amb R no sé massa com funciona.
...
# Jo treuria aquestes dues gràfiques, ja què la informació que aporten per si
# mateixes no és suficient com per representar-les gràficament.
...
# He canviat el tipus de gràfic perquè ocupi menys espai. Només he representat
les variables finals.
