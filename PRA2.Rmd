...
Representem els histogrames de les variables *renewable_generation_mw* i
*renewable_generation_perc* en funció de la variable *energy_source*:
...
Representem l'histograma de la variable  en funció
de la variable *energy_source*:
