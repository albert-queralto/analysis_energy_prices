...
A continuació, transformarem les columnes "date" i "hour" a tipus "date" i "time" respectivament, mentre que la columna "energy_source" es transformarà a tipus factor.
