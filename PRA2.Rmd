...
#### Nota: no funciona si faig servir mutate, però no acabo d'entendre el motiu. Cal mirar-ho perquè en principi el codi està bé. Potser cal afegir alguna opció.
...
A continuació, es combinen les columnes "date" i "hour" en una sola columna "datetime" i es transforma a tipus "datetime".
