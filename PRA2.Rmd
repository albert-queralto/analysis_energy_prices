...
final_dataset <- final_dataset %>% 
  ...
  energy_free_market_mwh, renewable_generation_mw), funs(gsub(".", "", ., fixed = TRUE)))
...
Mostrem el resultat de la transformació.
...
Finalment, transformem les columnes numèriques a tipus numèric.

#### Nota: no funciona si faig servir mutate, però no acabo d'entendre el motiu. Cal mirar-ho.
...
A continuació, comprovem el tipus de dades de cada columna del dataset.
