...
packages <- c("ggplot2", "plyr", "dplyr", "stats", "lmtest", "caret", "corrplot", "Hmisc", "rpart", "rpart.plot", "useful", "ROCR", "precrec", "knitr", "lubridate", "stringr", "psych", "pROC", "zoo", "reshape2", "gridExtra", "ggpubr", "rstatix", "lattice")
...
\scriptsize
```{r echo=TRUE, message=FALSE, warning=FALSE, fig.height=4, fig.width=8, fig.align='center'}
...
corrplot(corr_matrix_esios, method = "circle", type = "lower", 
          tl.col = "black", tl.srt = 10, tl.cex = 0.6)
```
\normalsize
...
total_price_hist <- ggplot(esios_dataset, aes(x = avg_total_price_eur_mwh)) + 
  ...
  labs(title = "avg_total_price_eur_mwh", x = "Avg total price (€/MWh)", 
...
\scriptsize
```{r echo=TRUE, message=FALSE, warning=FALSE, fig.height=2, fig.width=14, fig.align='center'}
...
\scriptsize
```{r echo=TRUE, message=FALSE, warning=FALSE, fig.height=3, fig.width=6, fig.align='center'}
