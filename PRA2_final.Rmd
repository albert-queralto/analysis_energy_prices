...
del vent, ja què hem considerat que no és útil per la nostre anàlisis. Així
...
percentatge de produccio d'energia renovable. Per això, crearem un subset de les
...
Jo faria algun test de contrast d'hipòtesis per exemple de la variable
*avg_total_price_eur_mwh* respecte els grups de *insolation_bin* i
*avg_pressure_bin*.
