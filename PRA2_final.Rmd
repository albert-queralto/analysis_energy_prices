...
Els resultats del model indiquen que l'energia èolica i la nuclear tenen una
influència més elevada en el preu del MWh respecte el valor de referència 
(l'energia hidroelèctrica), ja que tenen coeficients positius i amb valors més 
grans que la resta de fonts d'energia.
...
- Veiem com l'eòlica, la solar i l'hidroelèctrica són les energies renovables amb
un impacte més rellevant sobre el preu de l'energia. Les energies nuclear i 
termorenovable no presenten un pes tan significatiu respecte de la variable preu.
